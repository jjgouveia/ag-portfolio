...
const GlobalError: React.FC = () => {
  return (
    <>
      ...
      />
      <main className="flex flex-col justify-center items-center w-full h-screen text-center m-0 gap-4">
        <h1 className="font-thin text-[20pt] sm:text-[27pt] text-red-500 font-sans transform ease-in 0.9s">
          Site em Construção
        </h1>
        <svg
          version="1.1"
        ...
        >
          <g id="large">
            <g>
              <path
                d="M55.777,38.473l6.221-1.133c0.017-1.791-0.123-3.573-0.410-5.324l-6.321-0.19c-0.438-2.053-1.135-4.048-2.076-5.931
        ...
        <p className="font-light space-x-2 text-slate-600">
          Por favor, desculpe o inconveniente. <br />
        ...
        <div className="flex flex-row justify-center items-center space-x-2">
          <button className="mt-8 px-4 rounded">
            <Link href="/" rel="noreferrer">
              ...
              <p className="font-thin">Voltar para a home</p>
            </Link>
          </button>
        </div>
      </main>
      <footer className="flex flex-col justify-center items-center w-full h-16 text-center text-sm text-slate-600">
        <p>
          <i className="fa fa-copyright" aria-hidden="true" />{" "}
          {new Date().getFullYear()} - Todos os direitos reservados
        </p>
        <Image
          src="https://juniorgouveia.me/favicon.png"
          width={16}
          height={16}
          alt="juniorgouveia.me"
